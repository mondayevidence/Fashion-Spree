package com.evidence.newsvom.ui.widgets.stickyrecyclerheaders.rendering;
...
import com.evidence.newsvom.ui.widgets.stickyrecyclerheaders.caching.HeaderProvider;
    ...
    private boolean isStickyHeaderBeingPushedOffscreen(RecyclerView recyclerView, View stickyHeader) {
        ...
        if (firstViewUnderHeaderPosition > 0 && hasNewHeader(firstViewUnderHeaderPosition, isReverseLayout)) {
            ...
            if (mOrientationProvider.getOrientation(recyclerView) == LinearLayoutManager.VERTICAL) {
                int topOfNextHeader = 0;
                if (viewAfterHeader != null) {
                    topOfNextHeader = viewAfterHeader.getTop() - mTempRect1.bottom - nextHeader.getHeight() - mTempRect1.top;
                }
                ...
                int leftOfNextHeader = 0;
                if (viewAfterHeader != null) {
                    leftOfNextHeader = viewAfterHeader.getLeft() - mTempRect1.right - nextHeader.getWidth() - mTempRect1.left;
                }
